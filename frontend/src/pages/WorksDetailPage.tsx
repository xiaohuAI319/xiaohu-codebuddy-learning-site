...
const WorksDetailPage: React.FC = () => {
  ...
  const [upgradePrompt, setUpgradePrompt] = useState<{ show: boolean; requiredLevel: string; feature: string; showLoginButton?: boolean }>({ show: false, requiredLevel: '', feature: '' });
              ...
              {canUserAccessContent('prompt') ? (
                ...
                <div className="bg-gray-50 p-4 rounded-lg border-2 border-dashed border-gray-300">
                  ...
                  <div className="mt-3 text-center">
                    <button
                      onClick={() => {
                        setUpgradePrompt({ show: true, requiredLevel: '学员', feature: '查看提示词' });
                      }}
        ...
        <div className="space-y-4">
          ...
          <div className="bg-white rounded-lg shadow-md p-4">
            ...
            <div className="text-sm text-gray-700 space-y-1">
              <div>作品类型：{work.link ? 'URL' : (work.htmlFile ? 'HTML文件' : '未知')}</div>
